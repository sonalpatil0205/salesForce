...
public class SFDC_Excel {
	...
	public static void main(String[] args) throws Exception {
		...
		@Test
		public static void loginmain() throws IOException,NullPointerException {
			logger=reports.startTest("Test Login");
			FileInputStream File=new FileInputStream(System.getProperty("user.dir")+"\\TestData\\loginmain.xls");
			...
			//HSSFSheet sheet1=workbook.getSheet("ObjectInfo");
	 ...
	 * 
	 * switch(MenuText) { case "Accounts": break; case "Leads": break; case
	 * "Opportunities": break; case "Conatct":
	 * driver.findElement(By.xpath("//a[contains(text(),'Contacts')]")).click();
	 * logger.log(LogStatus.PASS, "Click on contact button "); break; case
	 * "My Profile": break; case "My Settings": break; case "Developer Console" :
	 * break;
	 * 
	 * 
	 * default :
	 * 
	 * } try { WebElement PopupWin =
	 * driver.findElement(By.xpath("//a[@id='tryLexDialogX']"));
	 * 
	 * PopupWin.click();
	 * 
	 * } catch(Exception E) { logger.log(LogStatus.INFO,
	 * "Pop up did not displayed"); }
	 * 
	 * }
	 */
		@Test
		...
		@Test
		public static void TS2_loginToSFDC() throws IOException {
			logger=reports.startTest("Login to SFDC");
			
            System.out.println("Present Project Directory : "+ System.getProperty("user.dir"));
			
			FileInputStream file=new FileInputStream(System.getProperty("user.dir") +"\\TestData\\TC_2_Login.xls");
			HSSFWorkbook workbook=new HSSFWorkbook(file);
			HSSFSheet sheet=workbook.getSheet("Sheet1");
			String userName = "";
			String password = "";
		 ...
		 * //System.out.println("click login button"); reports.endTest(logger);
		 */
			
	}
		@Test
		public static void TC3_rememberMeCheckBox() throws IOException
		{
			logger=reports.startTest("Test Login");
			System.out.println("Present Project Directory : "+ System.getProperty("user.dir"));

			FileInputStream file=new FileInputStream(System.getProperty("user.dir") +"\\TestData\\TC_3_Rememberme.xls");
			HSSFWorkbook workbook=new HSSFWorkbook(file); 
			HSSFSheet sheet=workbook.getSheet("Sheet1");
			String userName="";
			String password="";
		...
		@Test
		public static void TC4_forgotpasswordA() throws IOException{
		...
		@Test
		public static void TC5_forgotpasswordB() throws IOException {
			logger=reports.startTest("forgot password B");
			FileInputStream file=new FileInputStream(System.getProperty("user.dir") +"\\TestData\\TC_5_ForgotpassB.xls");
			HSSFWorkbook workbook=new HSSFWorkbook(file); 
			HSSFSheet sheet=workbook.getSheet("Sheet1");
			String userName="";
			String password="";
		...
		private static HSSFSheet getSheet(String strFileName, String strSheetName) throws IOException {
			
			FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\TestData\\"+ strFileName); 
			HSSFWorkbook workbook=new HSSFWorkbook(file);
			HSSFSheet sheet=workbook.getSheet(strSheetName);
			return sheet;
		}
		
		private static String getData(String strFileName, String strSheetName,String columnHeader) throws IOException {
			
			String strData="";
			FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\TestData\\"+ strFileName); 
			HSSFWorkbook workbook=new HSSFWorkbook(file);
			HSSFSheet worksheet=workbook.getSheet(strSheetName);
			...
			for (int currentColumnNum = 0; currentColumnNum < row.getLastCellNum(); currentColumnNum++) 
			{
				...
				currentValue = cell.getDateCellValue().toString();
		...
		@Test
		public static void TC05_usermenudropdown() throws IOException {
			logger=reports.startTest("Select user menu for <username> drop down");
//			FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\TestData\\TC05_usermenudropdown.xls"); 
//			HSSFWorkbook workbook=new HSSFWorkbook(file);
//			HSSFSheet sheet=workbook.getSheet("Sheet1");
//			
			HSSFSheet sheet = getSheet("TC05_usermenudropdown.xls","Sheet1");
		...
		@Test
		public static void TC06_selectmyprofile() throws InterruptedException, NullPointerException, IOException {
		...
		@Test
		public static void TC08_SelectDevelopersConsole() throws InterruptedException, IOException{
			loginmain();
		...
		@Test
		public static void TC24_ChecNewbuttonOnLeadsHome() throws IOException {
			loginmain();
		...
		@Test
		public static void TC32_ChecktheSaveandNewbutton() throws NullPointerException, IOException {
			loginmain();
			logger=reports.startTest("Test for Check the Cancel button works fine in Create New View");
			driver.findElement(By.xpath("//a[contains(text(),'Contacts')]")).click();
			logger.log(LogStatus.PASS, "Click on contact button ");
